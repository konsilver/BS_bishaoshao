...
public interface HistoryMapper extends BaseMapper<History>{
    ...
    @Select("SELECT crawl_date AS date, price FROM history WHERE thing_id = #{thingId} ORDER BY crawl_date DESC LIMIT 30")
    List<HistoryPrice> lookback(@Param("thingId") Long thingId);
